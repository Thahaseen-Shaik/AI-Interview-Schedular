...
function getMediaAccessHelpText() {
    return 'Camera and microphone require HTTPS or localhost. Open this interview from your Render HTTPS URL, a secure Cloudflare tunnel, or localhost instead of a plain HTTP LAN address.';
}
...
async function startCameraAndMic() {
    if (!navigator.mediaDevices?.getUserMedia) {
        showWarning('Camera and microphone access is not supported in this browser. Please use a modern Chrome, Edge, or Safari build.');
        return false;
    }

    if (!canAccessMediaDevices()) {
        showWarning(getMediaAccessHelpText());
        return false;
    }
