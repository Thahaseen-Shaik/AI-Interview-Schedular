    ...
    try:
        if _use_postgres():
            ...
            conn.cursor().execute(
                ...
                ADD COLUMN IF NOT EXISTS time_zone_offset_minutes INTEGER
                """
            )
            _commit(conn)
            return
        ...
        _ensure_column(conn, "interviews", "time_zone_offset_minutes", "INTEGER")
...
def schedule_interview(name, email, interview_time, time_zone_offset_minutes=None):
            ...
            if _use_postgres():
                ...
                cursor.execute(
                    ...
                    INSERT INTO interviews (
                        candidate_name, candidate_email, interview_time, time_zone_offset_minutes, token, status, ai_context
                    ...
                    (
                        ...
                        interview_time,
                        candidate.get("time_zone_offset_minutes"),
                        token,
                        "[]",
                    ),
                )
